...
struct State {
    ...
    input_systems: Schedule, // a schedule holds on to systems, responsible for managing systems
...
impl State {
    fn new() -> Self {
        ...
        // for the starting level, place stairs where we were previously rendering the amulet
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "You put on the Amulet of Yala and feel its power course though your veins.",
        );
        ctx.print_color_centered(
            5,
            WHITE,
    ...
    fn advance_level(&mut self) {
        ...
        // create a bucket for what we want to keep from the current world. (player and their items)
        use std::collections::HashSet;
        let mut entities_to_keep = HashSet::new();
        entities_to_keep.insert(player_entity);

        // find all the items carried by the player
        ...
        // remove everything from the world that is not the player or their items
        ...
        // house keeping: clear the player's field of view
